package com.marcotancredo.cursomc.services.validation.utils;
...
public class BR {
    ...
    public static boolean isValidCPF(final String cpf) {
        ...
        final int digit1 = calculate(cpf.substring(0,9), weightCPF);
        final int digit2 = calculate(cpf.substring(0,9) + digit1, weightCPF);
    ...
    public static boolean isValidCNPJ(final String cnpj) {
        ...
        final int digit1 = calculate(cnpj.substring(0,12), weightCNPJ);
        final int digit2 = calculate(cnpj.substring(0,12) + digit1, weightCNPJ);
